<template>  
  <div class="container">
    <div class="chefs-feed">
      <div class="heading">
        <h1>Chefs Feed</h1>
        <p>is a San Francisco brand that flips Yelp on its head with restaurant reviews from local chefs. I worked here as Lead Interactive Designer.</p>
      </div>
    </div>
    <div class="sub-body">
      <img src="~assets/cf.jpeg">
      <p>Chefs Feed was a very early stage startup when I joined, and we enlisted the help of Portland creative agency Instrument. When I asked for a gothic, DIN-like, rounded-but-not-too-friendly font for our logotype, they came back with a dozen! (Ultimately we went with Ultramagnetic.)</p>
